...
TABLET_TARGETS="gts7l gts7lwifi gts7fewifi"
...
elif echo "$TABLET_TARGETS" | grep -q -w "$TARGET_CODENAME"; then
    cp -a --preserve=all "$SRC_DIR/unica/mods/bootanim/tablet/"* "$WORK_DIR/system/system/media"
else
